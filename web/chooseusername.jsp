                ...
                <div class="span12">
                    ...
                    <div class="widget-box heavyBlackBorder inlineblock register">
                        <div class="widget-title">
                            ...
                            <h5>Please key in a username and password for your account</h5>
                        </div>
                        ...
                        <div class="widget-content nopadding">
                            <stripes:form class="form-horizontal" beanclass="com.lin.general.login.RegisterActionBean" focus="" name="registration_validate" id="registration_validate">
                                ...
                                <div class="control-group ${errorStyle}">
                                    ...
                                    <div class="controls">
                                        <stripes:password name="oldpassword" id="oldpassword" autocomplete="off"/>
                                    </div>
                                </div>
                                <div class="control-group ${errorStyle}">
                                <label class="control-label">New username:</label>
                                <div class="controls">
                                    <stripes:text name="username" id="username" autocomplete="off"/><a class="btn btn-mini btn-rhubarbarian-3 postLikeBtn" onclick="checkUser()"><i class="iconLike icon-search"></i> <span class="txt">Check</span></a>
                                </div>
                                </div>
                                <div class="control-group ${errorStyle}">
                                    <label class="control-label">New Password:</label>
                                    <div class="controls">
                                        <stripes:password name="newpassword" id="newpassword" autocomplete="off"/>
                                    </div>
                                </div>                             
                                <div class="control-group ${errorStyle}">
                                    <label class="control-label">Confirm New Password:</label>
                                    <div class="controls">
                                        <stripes:password name="newpasswordconfirm" id="newpasswordconfirm" autocomplete="off"/> 
                                    </div>
                                </div>                        
